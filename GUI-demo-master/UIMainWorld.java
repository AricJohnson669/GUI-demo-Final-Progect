...
public class UIMainWorld extends World
{
    ...
    private void testActors()
    {
         ...
         *          you want
         */
        Label label = new Label ("Hello World", 50);
         ...
         */
        TextBox textbox = new TextBox ("Hi", 24, true, Color.BLACK, Color.BLUE);
         ...
         */
        Menu menu = new Menu("Menu", "New \n Open \n Save \n Close \n Exit", 18, Color.BLUE, Color.BLACK, Color.BLUE, Color.BLACK, new FileCommands() );
